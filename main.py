...
def clear_item():
    ...
    unit_spinbox.delete(0, tkinter.END)
    unit_spinbox.insert(0, "0.0")
...
unit_label = tkinter.Label(frame, text="Unit Price")
unit_label.grid(row=2, column=2)
unit_spinbox = tkinter.Spinbox(frame, from_=0.0, to= 100, increment= 0.5)
